...
.method public static c(Landroid/content/Context;Landroid/os/CancellationSignal;La/g/i/a;)La/g/i/b$e;
    .locals 2
    ...
    invoke-static {v0, p2, v1}, La/g/i/b;->h(Landroid/content/pm/PackageManager;La/g/i/a;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    invoke-static {p0, p2, v0, p1}, La/g/i/b;->e(Landroid/content/Context;La/g/i/a;Ljava/lang/String;Landroid/os/CancellationSignal;)[La/g/i/b$f;
...
.method private static d(La/g/i/a;Landroid/content/res/Resources;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, p0}, La/g/d/d/c;->c(Landroid/content/res/Resources;I)Ljava/util/List;
...
.method static e(Landroid/content/Context;La/g/i/a;Ljava/lang/String;Landroid/os/CancellationSignal;)[La/g/i/b$f;
    .locals 20
...
.method static f(Landroid/content/Context;La/g/i/a;I)La/g/i/b$g;
    .locals 3

    const/4 v0, 0x0

    :try_start_0
    invoke-static {p0, v0, p1}, La/g/i/b;->c(Landroid/content/Context;Landroid/os/CancellationSignal;La/g/i/a;)La/g/i/b$e;
    ...
    invoke-static {p0, v0, p1, p2}, La/g/e/d;->b(Landroid/content/Context;Landroid/os/CancellationSignal;[La/g/i/b$f;I)Landroid/graphics/Typeface;
...
.method public static g(Landroid/content/Context;La/g/i/a;La/g/d/d/f$a;Landroid/os/Handler;ZII)Landroid/graphics/Typeface;
    .locals 2
    ...
    invoke-virtual {p2, v1}, La/g/d/d/f$a;->d(Landroid/graphics/Typeface;)V
    ...
    invoke-static {p0, p1, p6}, La/g/i/b;->f(Landroid/content/Context;La/g/i/a;I)La/g/i/b$g;
    ...
    invoke-virtual {p2, p1, p3}, La/g/d/d/f$a;->b(Landroid/graphics/Typeface;Landroid/os/Handler;)V

    goto :goto_0

    :cond_2
    invoke-virtual {p2, p1, p3}, La/g/d/d/f$a;->a(ILandroid/os/Handler;)V
    ...
    invoke-virtual {p1, v1, p5}, La/g/i/c;->e(Ljava/util/concurrent/Callable;I)Ljava/lang/Object;
    ...
    invoke-direct {p1, p2, p3}, La/g/i/b$b;-><init>(La/g/d/d/f$a;Landroid/os/Handler;)V
    ...
    invoke-virtual {p1, v1, p2}, La/g/i/c;->d(Ljava/util/concurrent/Callable;La/g/i/c$d;)V
...
.method public static h(Landroid/content/pm/PackageManager;La/g/i/a;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    .locals 5
    ...
    invoke-static {p1, p2}, La/g/i/b;->d(La/g/i/a;Landroid/content/res/Resources;)Ljava/util/List;
    ...
    invoke-static {p0, p2}, La/g/i/b;->b(Ljava/util/List;Ljava/util/List;)Z
...
.method public static i(Landroid/content/Context;[La/g/i/b$f;Landroid/os/CancellationSignal;)Ljava/util/Map;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    invoke-static {p0, p2, v3}, La/g/e/k;->f(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;

...
.method public b(Lc/a/b/a/h;Lc/a/b/a/i$d;)V
    ...
    invoke-static {v3, v2}, Lc/a/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v1, p1}, Lio/flutter/embedding/engine/i/f$h;->e(Ljava/lang/String;)V

    :cond_2
    :goto_1
    invoke-interface {p2, v3}, Lc/a/b/a/i$d;->c(Ljava/lang/Object;)V
    ...
    :try_start_2
    invoke-static {p1}, Lio/flutter/embedding/engine/i/f$e;->d(Ljava/lang/String;)Lio/flutter/embedding/engine/i/f$e;
    ...
    invoke-interface {p2, v0, p1, v3}, Lc/a/b/a/i$d;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v2, p1}, Lio/flutter/embedding/engine/i/f$h;->j(Lio/flutter/embedding/engine/i/f$e;)Ljava/lang/CharSequence;
    ...
    invoke-interface {p1}, Lio/flutter/embedding/engine/i/f$h;->a()V
    :try_end_3
    ...
    invoke-static {v1, p1}, Lio/flutter/embedding/engine/i/f;->e(Lio/flutter/embedding/engine/i/f;Lorg/json/JSONObject;)Lio/flutter/embedding/engine/i/f$j;
    ...
    invoke-interface {v1, p1}, Lio/flutter/embedding/engine/i/f$h;->f(Lio/flutter/embedding/engine/i/f$j;)V
    ...
    invoke-interface {p1}, Lio/flutter/embedding/engine/i/f$h;->d()V
    :try_end_5
    ...
    invoke-static {v1, p1}, Lio/flutter/embedding/engine/i/f;->d(Lio/flutter/embedding/engine/i/f;Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-interface {v1, p1}, Lio/flutter/embedding/engine/i/f$h;->c(Ljava/util/List;)V
    ...
    invoke-static {v1, p1}, Lio/flutter/embedding/engine/i/f;->c(Lio/flutter/embedding/engine/i/f;Lorg/json/JSONObject;)Lio/flutter/embedding/engine/i/f$c;
    ...
    invoke-interface {v1, p1}, Lio/flutter/embedding/engine/i/f$h;->h(Lio/flutter/embedding/engine/i/f$c;)V
    ...
    invoke-static {v1, p1}, Lio/flutter/embedding/engine/i/f;->b(Lio/flutter/embedding/engine/i/f;Lorg/json/JSONArray;)I
    ...
    invoke-interface {v1, p1}, Lio/flutter/embedding/engine/i/f$h;->g(I)V
    ...
    invoke-static {p1}, Lio/flutter/embedding/engine/i/f$g;->d(Ljava/lang/String;)Lio/flutter/embedding/engine/i/f$g;
    ...
    invoke-interface {v1, p1}, Lio/flutter/embedding/engine/i/f$h;->i(Lio/flutter/embedding/engine/i/f$g;)V
    ...
    invoke-static {p1}, Lio/flutter/embedding/engine/i/f$i;->d(Ljava/lang/String;)Lio/flutter/embedding/engine/i/f$i;
    ...
    invoke-interface {v1, p1}, Lio/flutter/embedding/engine/i/f$h;->b(Lio/flutter/embedding/engine/i/f$i;)V

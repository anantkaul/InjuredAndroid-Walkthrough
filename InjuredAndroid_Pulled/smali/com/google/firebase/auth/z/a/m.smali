.class final Lcom/google/firebase/auth/z/a/m;
...
.method public constructor <init>(Lcom/google/firebase/auth/c;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/auth/z/a/m;->y:Lcom/google/firebase/auth/c;
...
.method public final a()Lcom/google/android/gms/common/api/internal/m;
    ...
    new-instance v1, Lcom/google/firebase/auth/z/a/l;

    invoke-direct {v1, p0}, Lcom/google/firebase/auth/z/a/l;-><init>(Lcom/google/firebase/auth/z/a/m;)V
...
.method final synthetic q(Lcom/google/firebase/auth/z/a/n0;Lb/c/a/a/f/h;)V
    ...
    iget-object p2, p0, Lcom/google/firebase/auth/z/a/m;->y:Lcom/google/firebase/auth/c;

    invoke-virtual {p2}, Lcom/google/firebase/auth/c;->k()Ljava/lang/String;

    move-result-object p2

    iget-object v0, p0, Lcom/google/firebase/auth/z/a/m;->y:Lcom/google/firebase/auth/c;

    invoke-virtual {v0}, Lcom/google/firebase/auth/c;->n()Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lcom/google/firebase/auth/z/a/z0;->d:Lcom/google/firebase/auth/n;

    invoke-virtual {v1}, Lcom/google/firebase/auth/n;->x()Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lcom/google/firebase/auth/z/a/z0;->b:Lcom/google/firebase/auth/z/a/b1;

    invoke-interface {p1, p2, v0, v1, v2}, Lcom/google/firebase/auth/z/a/s0;->v(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/google/firebase/auth/z/a/r0;)V

    return-void

    :cond_0
    new-instance p2, Lb/c/a/a/d/c/o0;

    iget-object v0, p0, Lcom/google/firebase/auth/z/a/m;->y:Lcom/google/firebase/auth/c;

    invoke-virtual {v0}, Lcom/google/firebase/auth/c;->k()Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lcom/google/firebase/auth/z/a/m;->y:Lcom/google/firebase/auth/c;

    invoke-virtual {v1}, Lcom/google/firebase/auth/c;->n()Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lcom/google/firebase/auth/z/a/z0;->d:Lcom/google/firebase/auth/n;

    invoke-virtual {v2}, Lcom/google/firebase/auth/n;->x()Ljava/lang/String;

    move-result-object v2

    invoke-direct {p2, v0, v1, v2}, Lb/c/a/a/d/c/o0;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lcom/google/firebase/auth/z/a/z0;->b:Lcom/google/firebase/auth/z/a/b1;

    invoke-interface {p1, p2, v0}, Lcom/google/firebase/auth/z/a/s0;->G(Lb/c/a/a/d/c/o0;Lcom/google/firebase/auth/z/a/r0;)V
